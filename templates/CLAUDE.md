...
- **Pre-execution intent:** Before destructive or hard-to-reverse actions, append `PENDING: YYYY-MM-DD | [action] | [why]` to `.claude/event-journal.log`, then update to `DONE:` after.
